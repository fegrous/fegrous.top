...
const add_id = "kn0foyn7ucunfrnn"; // app_id
const app_secret = "sgxHCNg0e8F7UzBGBhPTbZA0lHlmjaEx"; // app_secret
const key = "3fcabebffb7045b1b44ecef852de33d0" // key
function getWeather() {
...
$('#switchmore').on('click', function () {
    ...
    if (shoemore && $(document).width() >= 990) {
        ...
        $("#change1").html("一条咸鱼的小破站，记录着平淡的生活");
    }
});
